...
namespace WEBPOS.WebForms
{
    public partial class ClosureWebForm1 : System.Web.UI.Page
    {
        ...
        private void PrintPosClosure(string[] queryString)
        {
            ...
            var difference = new ReportParameter("TotalDifference", ((closure.BeginAmount + closure.Total) - closure.BeginAmount).ToString("N2"), true);

            var resultText = ((closure.BeginAmount + closure.Total) - closure.BeginAmount) < 0 ? "cuadre INCORRECTO" : "cuadre CORRECTO";
